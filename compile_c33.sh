...
arduino-cli compile -b arduino:renesas_portenta:portenta_c33  --library "/home/c.dragomir/ArduinoWorkspace/Repos/Arduino_PF1550"
arduino-cli upload -b arduino:renesas_portenta:portenta_c33 --port "/dev/ttyACM0"